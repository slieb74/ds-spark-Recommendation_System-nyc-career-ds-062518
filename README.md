...
```
    ...
    <ipython-input-6-8ed896521225> in <module>()
          3 
          4 processedPath = 'processed'
    ----> 5 os.mkdir(processedPath)
          6 
          7 smallMoviesRDD.saveAsTextFile(os.path.join(processedPath, 'moviesRDD'))
